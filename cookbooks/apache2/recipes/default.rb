...
template "#{node[:apache][:dir]}/conf.d/svn_block.conf" do
  source "svn_block.conf.erb"
  owner "root"
  group "root"
  mode 0644
  backup false
...
file "#{node[:apache][:default_docroot]}/index.html" do
  action :delete
  backup false
end
...
include_recipe "apache2::maintenance_site"
