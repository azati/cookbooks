...
remote_file "/mnt/nginx-0.7.64.tar.gz" do
  source "nginx-0.7.64.tar.gz"
end
remote_file "/mnt/gnosek-nginx-upstream-fair-2131c73.tar.gz" do
  source "gnosek-nginx-upstream-fair-2131c73.tar.gz"
end
remote_file "/mnt/ngx_http_auth_pam_module-1.1.tar.gz" do
  source "ngx_http_auth_pam_module-1.1.tar.gz"
end
...
directory "/mnt/nginx-0.7.64" do
  recursive true
  action :delete
end
file "/mnt/nginx-0.7.64.tar.gz" do
  action :delete
end
